...
const SystemMap: React.FC = () => {
    const routeMap = [
        ...
        { route: ROUTES.APPOINTMENTS, parent: 'Navbar (redirects to Teleconsultation)' },
        ...
        { route: ROUTES.TELECONSULTATION, parent: 'Safety (both APPOINTMENTS and TELECONSULTATION routes point here)' },
        { route: ROUTES.VACCINATION, parent: 'Safety / Preventive' },
