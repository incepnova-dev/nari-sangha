...
// Re-export ExternalGroup for convenience (it's actually defined in ExternalGroupsList)
export type { ExternalGroup } from './ExternalGroupsList';

interface CreatedGroupsListProps {
  myCreatedGroups: CreatedGroup[];
  setViewMode: (mode: string) => void;
  setMode: (mode: string) => void;
}

const CreatedGroupsList: React.FC<CreatedGroupsListProps> = ({ myCreatedGroups, setViewMode, setMode }) => {
  return (
