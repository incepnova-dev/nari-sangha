...
interface CreateCardProps {
  ...
  handleCreateChange: (field: keyof CreateForm) => (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void;
  previewCreate: () => void;
  continueCreate: () => void;
}

const CreateCard: React.FC<CreateCardProps> = ({ createForm, handleCreateChange, previewCreate, continueCreate }) => {
  return (
