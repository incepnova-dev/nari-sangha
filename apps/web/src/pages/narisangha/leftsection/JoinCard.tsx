...
interface JoinCardProps {
  joinForm: JoinForm;
  handleJoinChange: (field: keyof JoinForm) => (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
  previewJoin: () => void;
  continueJoin: () => void;
}

const JoinCard: React.FC<JoinCardProps> = ({ joinForm, handleJoinChange, previewJoin, continueJoin }) => {
  return (
